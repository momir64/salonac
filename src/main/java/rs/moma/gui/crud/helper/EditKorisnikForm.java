...
public class EditKorisnikForm {
    public static void fillInputKorisnik(Korisnik korisnik, JTextField imeTxt, JTextField prezimeTxt, JComboBox<NameValue> polBox, JTextField telefonTxt, JTextField adresaTxt, JTextField usernameTxt, JTextField lozinkaTxt) {
